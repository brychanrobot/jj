...
#[test]
fn test_fix_include_unchanged_files() {
    let test_repo = TestRepo::init();
    let repo = &test_repo.repo;
...
#[test]
fn test_fix_sequence_formatted_from_base() {
    let test_repo = TestRepo::init();
    let repo = &test_repo.repo;
...
#[test]
fn test_fix_conflicted_base_commit() {
    let test_repo = TestRepo::init();
    let repo = &test_repo.repo;
...
#[test]
fn test_fix_conflicted_current_commit() {
    let test_repo = TestRepo::init();
    let repo = &test_repo.repo;
...
#[test]
fn test_fix_empty_file_not_formatted() {
    let test_repo = TestRepo::init();
    let repo = &test_repo.repo;
...
fn test_fix_forking_commits_same_file_id_different_base_content() {
    ...
    let mut file_fixer = TestFileFixer::new();
    file_fixer.add_replacement(path, Some(b"base A"), b"unformatted", b"unformatted");
